...
import { headingAnchorStyles } from '@/layouts/ComponentsMDX/ComponentsMDX';

# O projektu

## Iskalnik po osebnih zdravnikih<HeadingAnchor headingText="Iskalnik po osebnih zdravnikih"/>
...
### Ekipa<HeadingAnchor headingText="Ekipa" />
...
### Pogoji uporabe<HeadingAnchor headingText="Pogoji uporabe" />
...
### Varstvo osebnih podatkov<HeadingAnchor headingText="Varstvo osebnih podatkov" />
...
### Obdelava podatkov o osebnih zdravnikih<HeadingAnchor headingText="Obdelava podatkov o osebnih zdravnikih" />
...
### Obdelava osebnih podatkov o obiskovalcih spletne strani<HeadingAnchor headingText="Obdelava osebnih podatkov o obiskovalcih spletne strani" />
...
### Piškotki<HeadingAnchor headingText="Piškotki" />
